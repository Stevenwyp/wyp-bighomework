...
import com.example.finalhomework.widget.RecyclerExtras.OnItemClickListener;
import com.example.finalhomework.widget.RecyclerExtras.OnItemLongClickListener;
...
public class RecyclerGridAdapter extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    public void onItemClick(View view, int position) {
        @SuppressLint("DefaultLocale") String desc = String.format("11您点击了第%d项，名称是%s", position + 1,
    ...
    public void onItemLongClick(View view, int position) {
        @SuppressLint("DefaultLocale") String desc = String.format("11您长按了第%d项，名称是%s", position + 1,
                mGoodsArray.get(position).title);
        Toast.makeText(mContext, desc, Toast.LENGTH_SHORT).show();
    }
}
