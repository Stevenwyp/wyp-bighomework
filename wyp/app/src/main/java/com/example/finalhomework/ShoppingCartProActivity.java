...
public class ShoppingCartProActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    private ArrayList<GoodsInfo> mSearchArray;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_shopping_channel) { // 点击了“商场”按钮
            ...
            builder.setTitle("结算宠物");
            builder.setMessage("客官，该服务还未开通，下次再来吧");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_detail) { // 点击了菜单项“查看商品详情”
            ...
            Toast.makeText(this, "已删除" + mCurrentGood.goods.name, Toast.LENGTH_SHORT).show();
            // 刷新购物车列表
            showCart();
        }
        return true;
    ...
    protected void onResume() {
        ...
        // 获取购物车数据库的帮助器对象
//        mSearchArray = mGoodsHelper.query(String.format("name like %s%s%s","'%", queryString, "%'"));
